...
function NotFound() {
  ...
  return (
    <div className="min-h-[80vh] w-full flex flex-col justify-center items-center bg-brand-primary/2">
      ...
      <h1 className="text-5xl font-black text-brand-primary tracking-tighter mb-4">404</h1>
      <h2 className="text-2xl font-black text-brand-primary/60 uppercase tracking-widest mb-3">Page Not Found</h2>
