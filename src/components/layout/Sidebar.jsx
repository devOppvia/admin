    ...
    const menuGroups = [
        ...
        },
        {
            ...
            items: [
                ...
                { name: 'Contact Inquiries', icon: HelpCircle, path: '/contact-inquiry' },
            ]
        }
    ];
    ...
    return (
        <aside className="w-64 lg:w-72 bg-brand-primary h-full flex flex-col border-r border-white/10 shrink-0">
            ...
            <div className="h-20 w-full mx-auto flex items-center px-8 border-b border-white/5">
                ...
                <img src={"oppvia.webp"} alt="" className='h-12 w-[80%] mx-auto object-contain' />
            </div>
            ...
            <div className="p-4 border-t border-white/5">
                <button className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-white/60 hover:text-red-400 hover:bg-red-400/5 transition-colors group">
